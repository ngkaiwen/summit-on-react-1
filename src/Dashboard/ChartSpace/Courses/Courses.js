  ...
  render() {
    ...
    return (
      ...
      <div className='courses-main-container'>
          ...
          <div className='courses-grid-container'>
          <div className='course-grid-item-joint'>
              <h2>Distribution of average Code Combat levels completed<h5> for students in each course</h5></h2>
          ...
          <div className='courses-grid-container'>
          <div className='course-grid-item-joint'>
              <h2>Maximum Number of Code Combat Levels Completed <h5> >=75% Completion Rate for each Course</h5></h2>
